...
>   - This is a link directly to the repository. PlatformIO knows how to get the library files from this (they are .cpp and .h files which stand for C++ and header, respectively).
> - *EnviroDIY_ModularSensors@>=0.17.2*
>   - This directs PlatformIO to go get all libraries curated by Modular Sensors repository from the default branch (master) and any version greater than or equal to 0.12.2, which is the current release at the time of writing this tutorial.
