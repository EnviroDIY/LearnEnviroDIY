...
>
>You may notice that the items listed under lib_deps look like URLs. They are links to GitHub repositories, which allows you to get the current version of the libraries. Here are three ways you can link to libraries:
